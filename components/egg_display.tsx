...
export function EggDisplay({ eggSrc, nestSrc, patternSrc, auraSrc, crackSrc }: EggDisplayProps) {
      ...
      >
        ...
        {crackSrc && (
          <img
            src={crackSrc}
            alt="たまごのひび"
            className="pointer-events-none absolute inset-0 z-30 m-auto h-[90%] w-[90%] object-contain"
          />
        )}
