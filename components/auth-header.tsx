...
export function AuthHeader() {
  return (
    <header className="fixed inset-x-0 top-0 z-50 flex h-20 items-center justify-center bg-[#FFFCF3] px-4">
      ...
      {/* ※Aboutページへのリンク（Infoアイコン）は、登録・同意に集中させるため削除しています */}
